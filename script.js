...
const apikey = '30e6cfd58ec18a6461d2f594415b6e29';
...
function updateForecastItems(weatherData) {
  ...
  const forecastItem = `
    <div class="forecast-item">
      <h5 class="forecast-item-date regular-txt">${new Date(date).toLocaleDateString('en-GB', { day: '2-digit', month: 'short' })}</h5>
